...
namespace Game.Modules.PlayerModule.Scripts.PlayerAnimations {
    public class IdleAimPlayerAnimation : BasePlayerAnimation {
        ...
        bool isLeftDirection
            ...
            TrackEntry idleTrack = spineAnimationService.SetAnimationAndGetTrack(animationState, idleAnimation, AIM_IDLE_TRACK_INDEX, IDLE_ANIMATION_LOOP);
            ...
            TrackEntry aimTrack = spineAnimationService.SetAnimationAndGetTrack(animationState, aimAnimation, AIM_ANIMATION_TRACK_INDEX, IDLE_ANIMATION_LOOP);
